...
- CASM-4350: Implement a prototype of Split config maps, to store cray-product-catalog data...
- CASM-4368: Implement a prototype to delete cray-product-catalog data from main and sub cm 
