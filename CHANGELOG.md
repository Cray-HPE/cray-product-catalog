...
- Bump `actions/checkout` from 4 to 7 ([#377](https://github.com/Cray-HPE/cray-product-catalog/pull/377), [#381](https://github.com/Cray-HPE/cray-product-catalog/pull/381), [#382](https://github.com/Cray-HPE/cray-product-catalog/pull/382))
- Update Python dependencies to pick up upstream fixes.
